...
define("SQLITE_DATABASE", "/datos/usuarios/alumnos/a041746825p/biblioteca.sqlite"); // Ubicación de la base de datos
...
$tamEmail = 100;           // Tamaño del campo Apellidos
$tamTelefono = 9;           // Tamaño del campo Apellidos
