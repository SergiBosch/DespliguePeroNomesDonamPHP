...
function mi_funcion()
{
	echo "Mi funci�n ha sido invocada"; //instrucciones
	return 5;
}
mi_funcion();
...
/*
 * Ejercicio 2: Explicar que hace la funci�n reset, current y next
 * sobre arrays.
 * Poner alg�n otro ejemplo.
 * �Qu� es el paso de par�metros por Valor?
 * 
...
/*
 * func_num_args() Obtiene el n�mero de argumentos pasados a la funci�n.
 * func_get_arg() Obtiene el argumento especificado de una lista de argumentos de una funci�n definida por el usuario.
 * 
 */
?>